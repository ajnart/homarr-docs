...
Make sure to enable the "allow anonymouse access" [option in the settings](/docs/customizations/board-customization#access), if you want to allow people without an account to be able to see your dashboard (not edit)
