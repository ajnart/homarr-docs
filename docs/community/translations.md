...
Go to the [Crowdin translations](https://crwd.in/homarr) and select a language you want to translate. You can then enter the translation mode and start translating. After you've submitted your translations, a Proofreader will review your changes. After a translation has been approved, it will be merged to the language development branch. We merge this one periodically to the development branch. After the next update of Homarr, all changes from the development branch will be merged, including the changes in the translations.
