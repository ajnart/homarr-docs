...
Homarr can now be seamlessly integrated into your Home Assistant setup with our new add-on. This is perfect for users who rely on Home Assistant as their primary server and don't have a separate device for hosting. With this add-on, you can easily access and manage Homarr directly within Home Assistant.

### Prerequisites

- [Home Assistant](https://www.home-assistant.io/getting-started/)
- Access to your Home Assistant's Supervisor panel.
